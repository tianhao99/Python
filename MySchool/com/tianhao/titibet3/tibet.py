...
if __name__ == '__main__':
    # 确定首页网址
    # 1、新闻藏区西藏【】
    url = 'https://ti.tibet3.com/news/tibet/xz/'
    pages = 523
    urls = []
    urls.append(url)
    ...
    # 确定文件写入位置：相对路径
    file = 'གསར་འགྱུར།/བོད་ཁུལ།'
    getTitleAndUrl(urls,file)


    # 2、新闻藏区青海【】
    url = 'https://ti.tibet3.com/news/tibet/qh/'
    pages = 597
    urls = []
    urls.append(url)
    for i in range(2, pages):
    ...
    # 3、新闻藏区四川【】
    url = 'https://ti.tibet3.com/news/tibet/sc/'
    pages = 91
    urls = []
    urls.append(url)
    for i in range(2, pages):
    ...
    # 4、新闻藏区甘肃【】
    url = 'https://ti.tibet3.com/news/tibet/gs/'
    pages = 51
    urls = []
    urls.append(url)
    for i in range(2, pages):
    ...
    # 5、新闻藏区云南【】
    url = 'https://ti.tibet3.com/news/tibet/yn/'
    pages = 51
    urls = []
    urls.append(url)
    for i in range(2, pages):
