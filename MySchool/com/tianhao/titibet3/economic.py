...
if __name__ == '__main__':
    ...
    # 1、经济【】
    urls = []
    url = 'https://ti.tibet3.com/economy/matsa'
    pages = 7
    addUrls(url,pages)
    url = 'https://ti.tibet3.com/economy/gyursdngs'
    pages = 7
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/economy/khyumnor'
    pages = 7
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/economy/gdumgyud'
    pages = 7
    addUrls(url, pages)
