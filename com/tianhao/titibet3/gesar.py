...
if __name__ == '__main__':
    ...
    # 1、格尔萨王传【】
    urls = []
    url = 'https://ti.tibet3.com/gesar/people'
    pages = 1
    addUrls(url,pages)
    url = 'https://ti.tibet3.com/gesar/monuments'
    pages = 1
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/gesar/project'
    pages = 1
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/gesar/successor'
    pages = 1
    addUrls(url, pages)
