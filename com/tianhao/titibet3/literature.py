...
if __name__ == '__main__':
    ...
    # 1、文学【】
    urls = []
    url = 'https://ti.tibet3.com/literature/news'
    pages = 4
    addUrls(url,pages)
    url = 'https://ti.tibet3.com/literature/fiction'
    pages = 10
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/poem'
    pages = 25
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/prose'
    pages = 12
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/translation'
    pages = 8
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/treatise'
    pages = 15
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/special/gedunchopel'
    pages = 1
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/special/dundrugyal'
    pages = 1
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/special/khrusempa'
    pages = 3
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/special/zese'
    pages = 3
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/special/shudenyima'
    pages = 3
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/special/dubai'
    pages = 1
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/special/zhangqiaer'
    pages = 1
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/special/shengtaijiang'
    pages = 1
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/literature/special/qzx'
    pages = 1
    addUrls(url, pages)
