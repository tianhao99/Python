...
if __name__ == '__main__':
    ...
    # 1、科普【常识】
    urls = []
    url = 'https://ti.tibet3.com/general/buddhism'
    pages = 3
    addUrls(url,pages)
    url = 'https://ti.tibet3.com/general/science'
    pages = 5
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/general/health'
    pages = 11
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/general/life'
    pages = 17
    addUrls(url, pages)
    url = 'https://ti.tibet3.com/general/term'
    pages = 5
    addUrls(url, pages)
